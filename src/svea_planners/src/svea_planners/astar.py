...
class AStarPlanner(object):
    ...
    def __init__(self, world, init_pos, goal_pos):
        ...
        # Initialize contour (explored 'grey' cells) and visited ('black') set of cells
        self.contour = set()
        self.visited = set()
    ...
    def create_path(self):
        ...
        :return: path from the init goal to the goal
        :rtype: list(AStarNode)
        """
